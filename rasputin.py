...
'''
        ...
        #i do love my sc, so this is just a fun way to open a website
        elif 'robert space industries' or 'visit Mr.Roberts' or 'RSI' or 'sc' in statement:
            webbrowser.open_new_tab("https://robertsspaceindustries.com/")
            speak("AEGIS COMBAT ASSIST ENABLED")
            time.sleep(5)

        #more sc stuff
        elif 'gallog' or 'galactic logistics' or 'space trucking' or 'trading' in statement:
            webbrowser.open_new_tab("https://www.gallog.co/")
            speak("Trading data at hand")
            time.sleep(5)
		...
		#the command I always want siri to have, to power down
